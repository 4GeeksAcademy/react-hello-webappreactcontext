...
export const Contacto = ({ nombre, direccion, telefono, email, id, imagen }) => {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    swal("Tu contacto ha sido borrado!!", {
                        icon: "success",
                    });
                } else {
    ...
    return (
        <div className="mb-4">
            <div className="card m-3 carta">
                <img src={imagen} className="card-img-top rounded" alt="..." style={{ width: "100%", height: "200px", objectFit: "cover" }} />
                ...
                <div className="card-footer d-flex">
                    <button onClick={() => handleEdit(id)} class="editBtn m-auto">
                    ...
                    <button onClick={() => handleDelete(id)} class="button m-auto">
                        <svg
